...
export const SelectedSeatFull = () => {
    const { isOpen, onClose, type } = useModal()
    const router=useRouter()
    const isModalOpen = isOpen && type === "selectedSeatFull";
                ...
                <>
                    <div className="absolute left-0 right-0 top-0 bottom-0 bg-black/50 z-50 flex justify-center items-center">
                        <div className="bg-white  pt-10 pb-6 rounded-md flex flex-col">
                            <div className="px-32 text-2xl text-center font-bold text-black">Koltuk Dolu</div>
                            <div className="px-32 text-zinc-500 pt-2">Seçilen koltuk dolu durumdadır.Lütfen başka bir koltuk seçiniz.</div>
